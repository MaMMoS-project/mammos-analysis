    ...
    def __init__(
        ...
        Args:
            ...
            Hmax: :entity:`ExternalMagneticField` — largest field value in the linear
                segment.
            gradient: Slope of the linear fit (dimensionless).
            _H: Original :entity:`ExternalMagneticField` data (used for plotting).
            _M: Original :entity:`Magnetization` data (used for plotting).
            description: Description of the collection.
        """
        me._entity.ensure_entity("Remanence", Mr=Mr)
        ...
        if _H is not None:
            me._entity.ensure_entity("ExternalMagneticField", _H=_H)
            self["_H"] = _H

        if _M is not None:
            me._entity.ensure_entity("Magnetization", _M=_M)
            self["_M"] = _M
